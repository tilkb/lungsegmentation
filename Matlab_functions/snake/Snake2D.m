function [P,J]=Snake2D(I,P,model,Options)
...
%  Options.ShapeWeight: Weight of the shape similarity
%  Options.SizeWeight:Weight of the size of the lung similarity
%  Options.ExpectedSize: How big should the lung be.
% Literature:
...
% Process inputs
defaultoptions=struct('Verbose',false,'nPoints',100,'Wline',0.04,'Wedge',2,'Wterm',0.01,'Sigma1',10,'Sigma2',20,'Alpha',0.2,'Beta',0.2,'Delta',0.1,'Gamma',1,'Kappa',2,'Iterations',100,'GIterations',0,'Mu',0.2,'Sigma3',1,'SizeWeight',0,'ShapeWeight',0);
...
for i=1:Options.Iterations
    P=SnakeMoveIteration2D(S,P,Fext,Options.Gamma,Options.Kappa,Options.Delta,Options.ShapeWeight,Options.SizeWeight,model,Options.ExpectedSize);
